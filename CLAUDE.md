...
5. **Auto-Task Execution**: Sessions auto-start tasks when added to the Queue if the session is `Active`. Sequential processing is automatic.
...
- **Task lifecycle**: `todo → running → done` (Backlog removed)
